...
const DeleteAdmin = ({deleteAdmin, setDeleteAdmin}) => {
    ...
    const [nameValue, setNameValue] = useState(deleteAdmin);
        ...
        <>
            ...
            <div className = 'w3-modal-content'>
                <header className = 'w3-container'>
                    <span className='w3-button w3-text-red w3-display-topright' onClick = {()=>setDeleteAdmin(null)}>
                        <h4>X</h4>
                    </span>
                </header>
